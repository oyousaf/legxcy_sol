...
export default function About() {
  return (
    <section id="about" className="min-h-screen px-6 sm:px-12 py-24">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          {highlightItems.map((item, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-lg shadow-md text-left transition-all duration-300 hover:shadow-lg hover:border-[color:var(--accent-green)]"
            >
